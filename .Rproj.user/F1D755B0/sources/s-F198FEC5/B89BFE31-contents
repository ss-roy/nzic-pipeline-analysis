...
# Output file consists of ProjectID, Name of project, location, estimated completion date, funding status
...
results_summary <- results_summary %>% select(PrimaryKey,ProjectName,ProjectRegion,
                                              CommissionAssignedInfrastructureSector,FundingStatus,
